package com.peachdevops.community.constant;

import com.peachdevops.community.exception.GeneralException;
...
public enum ErrorCode {
    ...
    WRONG_ACCESS(20003,HttpStatus.BAD_REQUEST, "잘못된 접근입니다.");
